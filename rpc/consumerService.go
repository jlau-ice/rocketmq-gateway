...
type RocketMQGatewayServer struct {
	mqproto.UnimplementedRocketMQGatewayServer
}

func (s *RocketMQGatewayServer) Subscribe(req *mqproto.SubscribeRequest, stream mqproto.RocketMQGateway_SubscribeServer) error {
